...
<html lang="en">
    <head>
        ...
        <!-- Custom Theme Style -->
        <link href="<?php echo base_url() ?>resources/templateAdminGentella/build/css/custom.min.css" rel="stylesheet">
    </head>
                ...
                <div class="col-md-12">
                    <div class="col-middle">
                        <div class="text-center text-center">
                            ...
                            <p>La página que estas buscando no existe <a href="#"></a>
                            </p>
<!--                            <div class="mid_center">
        ...
        <script src="<?php echo base_url() ?>resources/templateAdminGentella/build/js/custom.min.js"></script>
    </body>
</html>
